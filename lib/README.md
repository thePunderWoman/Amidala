...
| HumanCyborgRelationsAPI | HCR vocalizer control (audio + emotions over I2C/serial) | https://github.com/thePunderWoman/HumanCyborgRelationsAPI (fork of roy86/HumanCyborgRelationsAPI with ESP32/IDF5 compile fixes — use tag 1.0.2 or later) |
